...
export const HANDCRAFTED_PROBLEMS: Problem[] = [
  {
    ...
    answer: 0,
    explanation: '박스권 돌파 + 매크로 동행 → 추세 가속. 1개월 뒤 상승 (+18%).',
    reveal: {
  ...
  },
  {
    ...
    answer: 0,
    explanation: '3개월 +20% 추가 상승 — 이후 분할 확정 시 "Sell the news" 하락. 1개월 뒤 상승 (+23%).',
    reveal: {
  ...
  },
  {
    ...
    answer: 0,
    explanation: '약세장 저점 컵 패턴 + AI 수요 태동 = 추세 반전 초입. 1개월 뒤 상승 (+19%).',
    reveal: {
      title: 'NVIDIA (NVDA)',
  ...
  },
  {
    ...
    choices: [
      ...
      '박스권이 지속된다',
      '하단을 이탈하여 하락한다',
      '가짜 상방 돌파 이후 매도세가 쏟아지며 급락한다 (페이크 상승)',
    ],
    answer: 3,
  ...
  },
  {
    ...
    answer: 0,
    explanation: '포물선 가속 + 주류 진입 = 끝을 예측 불가. 7개월 +421%. 분할 매도 필수. 1개월 뒤 상승 (+34%).',
    reveal: {
      title: 'Bitcoin (BTC/USD)',
      market: 'Crypto · 가상자산',
      period: '2017년 4월 ~ 2017년 8월',
      result: '1개월 후 상승 (+34%).',
  ...
  },
  {
    ...
    answer: 2,
    explanation: '시스템 위기 = 개별 충격이 전염으로 확산. 속도는 예측 불가. 1개월 뒤 급락 (-20%).',
    reveal: {
      title: 'S&P 500 (^GSPC)',
      market: 'NYSE · 미국 대형주',
  ...
  },
  {
    ...
    answer: 2,
    explanation: '"우리는 다르다" = 위기 전 가장 위험한 말. 1개월 뒤 급락 (-19%).',
    reveal: {
      title: 'KOSPI (^KS11)',
      market: 'KOSPI · 한국 시장',
      period: '1997년 3월 ~ 1997년 10월',
      result: '1개월 후 급락 (-19%).',
  ...
  },
  {
    ...
    answer: 2,
    explanation: '레버리지 버블 붕괴 → 청산 연쇄. 정부 개입도 한계. 1개월 뒤 급락 (-17%).',
    reveal: {
      title: '상하이 종합지수',
      market: '중국 상하이거래소',
  ...
  },
  {
    ...
    answer: 0,
    explanation: '버블 마지막 구간 가장 가파름 — "이미 너무 올랐다"도 틀릴 수 있다. 1개월 뒤 상승 (+16%).',
    reveal: {
      title: 'NASDAQ (^IXIC)',
      market: 'NASDAQ · 미국 기술주',
      period: '1999년 5월 ~ 1999년 12월',
      result: '1개월 후 상승 (+16%).',
  ...
  },
  {
    ...
    answer: 0,
    explanation: '공매도 140% + 집단 매수 → 숏 스퀴즈. 3개월 +901%. 관찰 후 대응. 1개월 뒤 상승 (+247%).',
    reveal: {
      title: 'GameStop (GME)',
      market: 'NYSE · 게임 소매',
  ...
  },
  {
    ...
    answer: 2,
    explanation: '독점적 실수요 + 테마 일치 = 실적 동반 폭등. 1개월 뒤 급락 (-20%).',
    reveal: {
      title: '씨젠 (096530.KQ)',
      market: 'KOSDAQ · 분자진단',
  ...
  },
  {
    ...
    answer: 0,
    explanation: '유동성 폭발 → BTC도 함께 V자. 공포에 매도 = 기회 손실. 1개월 뒤 상승 (+32%).',
    reveal: {
      title: 'Bitcoin (BTC/USD)',
      market: 'Crypto · 가상자산',
      period: '2019년 12월 ~ 2020년 5월',
      result: '1개월 후 상승 (+32%).',
  ...
  },
  {
    ...
    answer: 0,
    explanation: '경영 피벗 + 역대 저밸류 = 역발상 기회. 1개월 뒤 상승 (+19%).',
    reveal: {
  ...
  },
  {
    ...
    answer: 2,
    explanation: '고PER + 규제 + 금리 = 멀티플 압축 삼중 압박. 1개월 뒤 급락 (-28%).',
    reveal: {
      title: '카카오 (035720.KS)',
      market: 'KOSPI · 플랫폼',
  ...
  },
  {
    ...
    answer: 2,
    explanation: '하드웨어→서비스 구조 전환 인식 = 밸류에이션 재편 촉매. 1개월 뒤 급락 (-20%).',
    reveal: {
      title: 'Apple (AAPL)',
      market: 'NASDAQ · 빅테크',
      period: '2018년 6월 ~ 2019년 1월',
  ...
  },
  {
    ...
    answer: 0,
    explanation: '사이클 저점 + AI 구조적 수요 = 반등 이중 동력. 1개월 뒤 상승 (+19%).',
    reveal: {
      title: 'AMD',
      market: 'NASDAQ · 반도체',
      period: '2022년 6월 ~ 2023년 1월',
  ...
  },
  {
    ...
    answer: 0,
    explanation: 'PER 수백 배 + 개인 90% = 포물선 붕괴 전형 패턴. 1개월 뒤 상승 (+15%).',
    reveal: {
      title: '에코프로 (086520.KQ)',
      market: 'KOSDAQ · 2차전지 모회사',
  ...
  },
  {
    ...
    answer: 0,
    explanation: '연준 무제한 QE + 5조 달러 부양 = 유동성 폭발. 실업률 14.7%에도 주가는 V자를 그렸다. 1개월 뒤 상승 (+25%).',
    reveal: {
      title: 'S&P 500 (^GSPC)',
      market: 'NYSE · 미국 대형주',
      period: '2019년 9월 ~ 2020년 4월',
  ...
  },
  {
    ...
    answer: 0,
    explanation: '경영 피벗 + 역대 저밸류 + AI 광고 수익화 = 역발상 기회. 감원 발표 후 이익률이 빠르게 회복됐다. 1개월 뒤 상승 (+26%).',
    reveal: {
      title: 'Meta Platforms (META)',
  ...
  },
  {
    ...
    answer: 0,
    explanation: '비대면 가속 + 광고·커머스 폭발 = 실적 서프라이즈. 광고 매출이 전년 대비 30% 급증했다. 1개월 뒤 상승 (+24%).',
    reveal: {
      title: '네이버 (035420.KS)',
  ...
  },
  {
    ...
    answer: 0,
    explanation: '공매도 잔고 140% + 로빈후드 매수 유입 = 숏 스퀴즈 임계점 도달. 1개월 뒤 상승 (+184%).',
    reveal: {
      title: 'GameStop (GME)',
      market: 'NYSE · 게임 소매',
      period: '2020년 7월 ~ 2021년 2월',
  ...
  },
  {
    ...
    answer: 0,
    explanation: 'HBM 독점 공급 + AI 인프라 투자 폭증 = 구조적 수요. SK하이닉스는 HBM 시장점유율 50%를 확보했다. 1개월 뒤 상승 (+36%).',
    reveal: {
      title: 'SK하이닉스 (000660.KS)',
      market: 'KOSPI · 반도체·HBM',
      period: '2022년 11월 ~ 2023년 6월',
      result: '1개월 후 상승 (+36%).',
